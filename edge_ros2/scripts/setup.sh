...
echo ""
echo "    2. Place AWS IoT certs in: $PROJECT_ROOT/certs/"
echo "       - rootCA.pem"
echo "       - cert.pem"
echo "       - private.key"
echo ""
echo "    3. Export your ingest API key:"
echo "       export FW_INGEST_API_KEY=\"<your-ingest-api-key>\""
echo ""
echo "    4. Start the full pipeline:"
echo "       bash scripts/start.sh"
echo ""
echo "    5. Or launch through ROS2:"
echo "       ros2 launch fw_launch edge_pipeline.launch.py"
echo ""
echo "    6. Or start individual nodes:"
